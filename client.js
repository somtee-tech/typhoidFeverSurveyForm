(function() {
    ...
    */
            ...
            try {
                ...
                if (e && 0 < e.length) {
                    ...
                    for (d = {}; c < e.length;) {
                        ...
                        k = typeof p;
                        f = "object" == k && null !=
                            p || "function" == k ? "o" + (Object.prototype.hasOwnProperty.call(p, q) && p[q] || (p[q] = ++da)) : (typeof p).charAt(0) + p;
    ...
    var V = decodeURI("%73cript"),
        ...
        xa = function() {
            var a = F.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(W) ? a : F.nonce = null : z.querySelector ? (a = z.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(W) ? F.nonce = a : F.nonce = null) : null : null
        },
        za = function(a) {
            if ("loading" != z.readyState) ya(a);
            else {
                var b = xa(),
                    c = "";
                null !== b && (c = ' nonce="' + b + '"');
                a = "<" + V + ' src="' + encodeURI(a) + '"' + c + "></" + V + ">";
                z.write(Y ? Y.createHTML(a) : a)
            }
        },
        ya = function(a) {
            var b = z.createElement(V);
            b.setAttribute("src", Y ? Y.createScriptURL(a) : a);
            a = xa();
            null !== a && b.setAttribute("nonce", a);
            b.async = "true";
            (a = z.getElementsByTagName(V)[0]) ? a.parentNode.insertBefore(b, a): (z.head || z.body || z.documentElement).appendChild(b)
        },
        Aa = function(a, b) {
            var c = b && b._c;
            if (c)
        ...
        Ea = function(a, b) {
            ...
            if (e["::"] && b.length) {
                ...
                for (; b = a.shift();) Da(b.features, c, b.hint)
            } else Da(b || [], c, d)
        },
        Da = function(a, b, c) {
            a = ja(a) || [];
            ...
            if (r.length) {
                ...
                if (r.length) {
                    ...
                    a = ta(c, r, "gapi." + Q, l, Ia);
                    l.push.apply(l, r);
                    N("ml0", r, K);
                    b.sync || y.___gapisync ? za(a) : ya(a)
                } else v[w](ha)
            } else fa(r) && d && d()
        },
        Fa;
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.NnK9YPjtg-w.O/d=1/rs=AHpOoo9KePDGVlGjp-rlXwDM1kUO2Eh4gg/m=__features__",
